...
# model
parser.add_argument('--model', type=str, default='attentiontripnet', choices=['attentiontripnet'], help='Model name?')
...
#%% model
model = network.AttentionTripnet('resnet18', hr_output=hr_output).cuda()
