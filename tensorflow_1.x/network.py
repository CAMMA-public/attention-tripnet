...
class AttentionTripnet(object):
    def __init__(self, model='attentiontripnet', basename="resnet18", num_tool=6, num_verb=10, num_target=15, num_triplet=100, hr_output=False, dict_map_url="./"):
